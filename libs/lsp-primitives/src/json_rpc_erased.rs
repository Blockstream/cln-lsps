...
///
/// The JsonRpcMethodErased wraps the JsonRpcMethod and allows you to interface using Vec<u8>.
/// Under the hood, the underlying type will be used. But the error will be raised at run-time and
/// not at compile-time.
///
...
///
/// For library-authors the JsonRpcMethodUnerased is probably most suitable.
...
mod test {
    use super::*;
    use crate::json_rpc::{generate_random_rpc_id, DefaultError, JsonRpcMethod};
    ...
    fn create_rpc_request_from_method_erased() {
        ...
        // This rpc-request should work because the parameters match the schema

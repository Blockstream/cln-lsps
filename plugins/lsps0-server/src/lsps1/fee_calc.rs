...
pub trait FeeCalculator {
    fn calculate_fee(&self, context : &mut CustomMsgContext<PluginState>, order : Lsps1Order) -> Result<FeeCalculationResult>;
}
...
impl FeeCalculator for FixedFeeCalculator {
    ...
    fn calculate_fee(&self,  _context : &mut CustomMsgContext<PluginState>, order : Lsps1Order) -> Result<FeeCalculationResult> {
